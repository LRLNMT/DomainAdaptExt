...
preprocess () {
    ...
    path_to_data2="../Datasets/${lang}/train/${domain2}/${size2}/oversample/${size1}/"
...
main () {
    ...
    stage1_save_path="stage1-${domain1}-${size1}_${lang_pair}"
    save_path="OS-stage1-${domain1}-${size1}_stage2-${domain2}-${size2}_${lang_pair}"
